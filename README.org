...
- programs for i3: feh, gnome-screenshot, alsa-utils, xbacklight, playerctl, termite, rofi, dropbox, alarm-clock-applet, xfce4-power-manager, dunst, compton, redshift, xmobar, stalonetray, dmenu
- copy xmacros to .local/share/
