...
;---------------- packages requests and settings ---------------------
...
(global-set-key (kbd "C-l") 'linum-relative-toggle)
; helm M-x
(global-set-key (kbd "M-x") 'helm-M-x)
; ace-jump
(evil-leader/set-key "w" 'ace-jump-word-mode) ; çw for Ace Jump (word)
(evil-leader/set-key "l" 'ace-jump-line-mode) ; çl for Ace Jump (line)
(evil-leader/set-key "c" 'ace-jump-char-mode) ; çc for Ace Jump (char)define-key global-map (kbd "C-ç w") 'ace-jump-word-mode)
; esc quits
